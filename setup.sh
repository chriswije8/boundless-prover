...
apt update
apt install -y sudo curl nvtop git supervisor build-essential pkg-config libssl-dev python3-dev
echo
...
cd /root/boundless
git remote add upstream https://github.com/boundless-xyz/boundless.git
git fetch upstream tag 0.13.1
git checkout 0.13.1
