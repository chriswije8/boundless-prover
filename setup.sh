...
curl -L "https://www.dropbox.com/scl/fi/5qefdl2axhet8hlrynpax/broker?rlkey=vqxutoncklzc090fzg770se5f&st=foc7ptkb&dl=1" -o /app/broker
...
cargo install --git https://github.com/risc0/risc0 bento-client --branch release-2.1 --bin bento_cli --force
